export function draw() {
   ...
   const figures = [
      { img: null, x: 10, y: 130, w: 200, h: 240 }, // carney (moved right)
      { img: null, x: 200, y: 70, w: 220, h: 260 }, // pp (moved left)
      { img: null, x: 400, y: 100, w: 180, h: 220 }, // dog
   ];

   function preload() {
      carney = loadImage("carney.png");
      pp = loadImage("pp.png");
   ...
   //    nextButton.position(width / 2 - 40, height - 60); // ⬅️ near bottom
   //    nextButton.mousePressed(() => {
   //       window.location.href = "https://your-next-page.com"; // your link
   //    });
   // }
}
